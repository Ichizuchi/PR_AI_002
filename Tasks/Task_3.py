# Поиск в ширину по личному графу
...
def bfs_shortest_path(graph, start, goal):
    # Очередь для хранения путей и начальной точки
    ...
    while queue:
        ...
        for (neighbor, distance) in graph.get(vertex, []):
...
start_city = "Стамбул"
goal_city = "Ван"
path = bfs_shortest_path(graph, start_city, goal_city)
print("Кратчайший путь из", start_city, "в", goal_city, ":", path)
